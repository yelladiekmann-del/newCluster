...
const COLS_META: ColMeta[] = [
  { key: "companyCount",       group: "Size",       label: "Gesamt",                  higherIsBetter: true  },
  { key: "uniqueCompanies",    group: "Size",       label: "# Companies",             higherIsBetter: true  },
  { key: "avgEmployees",       group: "Size",       label: "⌀ Angestellte",           higherIsBetter: true  },
  { key: "avgYearFounded",     group: "Recency",    label: "⌀ Year Founded",          higherIsBetter: false },
  { key: "pctRecentlyFounded", group: "Recency",    label: "% Recently Founded",      higherIsBetter: true  },
  ...
  { key: "avgFunding",         group: "Funding",    label: "⌀ Total Raised",          higherIsBetter: true  },
  { key: "totalFunding",       group: "Funding",    label: "Σ Total Raised",          higherIsBetter: true  },
  { key: "totalInvested4yr",   group: "Funding",    label: "Σ Capital (4 Jahre)",     higherIsBetter: true,  dealsOnly: true },
  { key: "fundingMomentum",    group: "Funding",    label: "Funding Momentum",        higherIsBetter: true,  dealsOnly: true },
  { key: "capitalMean",        group: "Capital",    label: "Capital Invested Mean",   higherIsBetter: true,  dealsOnly: true },
  { key: "capitalMedian",      group: "Capital",    label: "Capital Invested Median", higherIsBetter: true,  dealsOnly: true },
  { key: "meanMedianRatio",    group: "Capital",    label: "Abweichung Mean/Median",  higherIsBetter: false, dealsOnly: true },
  { key: "vcGraduationRate",   group: "Risk",       label: "VC Graduation Rate",      higherIsBetter: true  },
  { key: "mortalityRate",      group: "Risk",       label: "Mortality Rate",          higherIsBetter: false },
  { key: "hhi",                group: "Market",     label: "Marktanteil (HHI)",       higherIsBetter: false },
  { key: "avgSeriesScore",     group: "Market",     label: "Marktreife",              higherIsBetter: true,  dealsOnly: true },
  { key: "avgPatentFamilies",  group: "Technology", label: "⌀ Patentierte Erf.",      higherIsBetter: true  },
];
